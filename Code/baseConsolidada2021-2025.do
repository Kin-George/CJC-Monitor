****************************************************
* BASE CONSOLIDADA GEIH 2021-2025
...
local cand_educ       "P6210 P3042 p6210 p3042 NIVEL_MAS_ALTO nivel_mas_alto"
...
foreach year of local anios {
    ...
    *================================================
    ...
    find_first_var, candidates("`cand_edad'")
    ...
    *================================================
    ...
    if "`var_ei'" == "" {
        local observacion "`observacion' Falta EI;"
    }
    ...
    * Variables no esenciales, pero se registran en auditoría
    ...
    di as result "Rama4D:    `var_rama4d'"
    ...
    *================================================
    ...
    rename EI_tmp EI
    label var EI "Variable EI original armonizada"
...
save "Outputs/tables/GEIH_consolidada_variables_interes_2021_2025.dta", replace

export delimited using "Outputs/tables/GEIH_consolidada_variables_interes_2021_2025.csv", ///
    replace delimiter(";")
...
save "Outputs/tables/auditoria_variables_geih_2021_2025.dta", replace

export excel using "Outputs/tables/auditoria_variables_geih_2021_2025.xlsx", ///
    firstrow(variables) replace


di "===================================================="
di "BASE CONSOLIDADA 2021-2025 CREADA CORRECTAMENTE"
di "DTA:"
di "Outputs/tables/GEIH_consolidada_variables_interes_2021_2025.dta"
di ""
di "CSV:"
di "Outputs/tables/GEIH_consolidada_variables_interes_2021_2025.csv"
di ""
di "AUDITORÍA:"
di "Outputs/tables/auditoria_variables_geih_2021_2025.xlsx"
di "===================================================="
...
tab anio if missing(EI)

tab anio ingreso_hora_valido, missing
