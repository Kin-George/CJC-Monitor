\begin{table}[htbp]
  ...
  \begin{tabular}{lccc}
    ...
    & (1) & (2) & (3) \\
    \midrule
    Firm size: 2-3 & 0.181*** & 0.240*** & 0.168*** \\
     & (0.034) & (0.030) & (0.036) \\
    Firm size: 4-5 & 0.360*** & 0.406*** & 0.263*** \\
     & (0.035) & (0.030) & (0.045) \\
    Firm size: 6-10 & 0.497*** & 0.500*** & 0.262*** \\
     & (0.029) & (0.033) & (0.057) \\
    Firm size: 11-19 & 0.625*** & 0.577*** & 0.245*** \\
     & (0.034) & (0.039) & (0.058) \\
    Firm size: 20-30 & 0.688*** & 0.604*** & 0.208*** \\
     & (0.045) & (0.045) & (0.057) \\
    Firm size: 31-50 & 0.759*** & 0.651*** & 0.208*** \\
     & (0.055) & (0.049) & (0.056) \\
    Firm size: 51-100 & 0.819*** & 0.699*** & 0.226*** \\
     & (0.062) & (0.052) & (0.054) \\
    Firm size: 101+ & 1.017*** & 0.818*** & 0.299*** \\
     & (0.101) & (0.066) & (0.066) \\
    \midrule
    Individual controls & No & No & Yes \\
    Sector-year fixed effects & No & Yes & Yes \\
    Observations & 5,034,706 & 5,034,706 & 5,034,706 \\
    $R^2$ & 0.212 & 0.269 & 0.366 \\
    \bottomrule
  \end{tabular}
  \vspace{0.3em}
