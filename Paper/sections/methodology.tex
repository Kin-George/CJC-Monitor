...
\begin{equation}
  ...
  + \varepsilon_{ist},
\end{equation}
where \(Trend_t\) is a linear year trend normalized to zero in 2008. The parameter \(\delta_g\) tests whether the wage premium for firm-size group \(g\) increased over time relative to solo workers. We report one-sided tests of \(H_0:\delta_g=0\) against \(H_1:\delta_g>0\), because the empirical question is
