...
Esta identidad permite separar tres márgenes distintos del crecimiento: cuánto produce la economía por hora trabajada, cuántas horas trabaja en promedio cada ocupado y cuántas personas están ocupadas. En términos de tasas de crecimiento anualizadas, el crecimiento del PIB puede expresarse como la combinación de esos tres componentes:

\[
1 + g_{\text{PIB}} =
\left(1 + g_{\text{PIB/Horas}}\right)
\left(1 + g_{\text{Horas/Ocupado}}\right)
\left(1 + g_{\text{Ocupados}}\right).
\]

Para tasas moderadas, esta relación también puede leerse de manera aproximada como una suma:

\[
g_{\text{PIB}} \approx g_{\text{PIB/Horas}} + g_{\text{Horas/Ocupado}} + g_{\text{Ocupados}}.
\]

Así, el crecimiento del PIB puede desagregarse entre el crecimiento del PIB por hora, el crecimiento de las horas por ocupado y el crecimiento del número de ocupados. Por eso el cuadro presenta, junto al PIB real, el número de ocupados, las horas semanales promedio por trabajador, el PIB por trabajador y el PIB por hora trabajada. La lectura conjunta de estos indicadores permite distinguir si el crecimiento del producto proviene principalmente de más empleo, de más horas por trabajador o de una mayor productividad por hora.

La misma identidad también permite conectar las dos medidas de productividad usadas en el informe:

\[
\frac{\text{PIB}}{\text{Ocupado}} =
\left(\frac{\text{PIB}}{\text{Horas}}\right)
\times
\left(\frac{\text{Horas}}{\text{Ocupado}}\right).
\]

Es decir, el PIB por trabajador combina dos elementos: cuánto se produce por cada hora trabajada y cuántas horas trabaja, en promedio, cada ocupado. Por esta razón, el PIB por trabajador puede crecer menos que el PIB por hora cuando las horas promedio por ocupado disminuyen, incluso si la economía produce más por cada hora efectiva de trabajo.
