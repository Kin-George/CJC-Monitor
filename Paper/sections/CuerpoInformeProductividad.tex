...
\textbf{El crecimiento del PIB puede desgregarse entre el crecimiento de los ocupados, el crecimiento de las horas trabajadas por cada ocupado y el crecimiento del PIB por hora trabajada}. El PIB puede expresarce como el producto entre el PIB por trabajdor y el numero de trabajadores, por lo cual el crecimiento del PIB puede desagregarse entre el crecimiento del PIB por trabjador y el crecimiento de los trabajadores:
...
A su vez,  el PIB por trabajador combina dos elementos: cuánto se produce por cada hora trabajada y cuántas horas trabaja, en promedio, cada ocupado:
...
\]
 ...
 La lectura conjunta de estos indicadores permite distinguir si el crecimiento del producto proviene principalmente de más empleo, de más horas por trabajador o de una mayor productividad por hora.
...
El Cuadro \ref{tab:ocupados_horas_resumen} resume la descomposición básica que guía esta sección. El PIB anual se obtiene de las cuentas nacionales del DANE y se expresa en pesos constantes de 2015. Los ocupados y las horas trabajadas provienen de la GEIH, expandidos con el factor de encuesta. 
