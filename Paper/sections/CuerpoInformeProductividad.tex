...
\textbf{La dimensión sectorial es central para entender la productividad.} La productividad agregada puede ocultar dinámicas muy distintas entre actividades económicas. Por eso, la parte sectorial del informe desagrega el PIB, la ocupación, las horas trabajadas, el PIB por trabajador y el PIB por hora para las doce agrupaciones CIIU usadas por el DANE. El resultado principal es que la productividad por actividad económica muestra trayectorias muy heterogéneas: sectores como información y comunicaciones, agropecuario y artes, otros servicios y hogares registran aumentos importantes, mientras que minas, construcción, servicios públicos y actividades profesionales y administrativas muestran caídas en el PIB por trabajador o en el PIB por hora trabajada.

\textbf{Una pregunta central es si la ocupación creció en los sectores donde también creció la productividad.} Los resultados muestran que, entre 2010 y 2025, las actividades donde más aumentó el número de ocupados no fueron necesariamente aquellas donde más creció el PIB por trabajador o el PIB por hora trabajada. Esto conecta el informe con una agenda más amplia sobre eficiencia en la asignación de recursos: no solo importa cuánto empleo se crea, sino en qué actividades se concentra. Por esa razón, este informe debe leerse como la primera pieza de una serie más amplia del Centro Javeriano de Competitividad sobre productividad en Colombia. Informes posteriores podrán estudiar con más detalle la asignación del trabajo entre actividades económicas, la formalidad, el tamaño de la empresa, el capital humano y otros mecanismos que ayudan a explicar por qué algunos sectores logran transformar empleo y horas trabajadas en mayor valor agregado.
