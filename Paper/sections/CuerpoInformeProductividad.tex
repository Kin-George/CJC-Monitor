...
Para el análisis por actividad económica, el valor agregado del DANE y la información laboral de la GEIH deben estar expresados en las mismas actividades económicas. La medición de productividad laboral se hace con las doce agrupaciones CIIU Rev. 4 A.C. que pueden cruzarse de manera comparable con ocupados y horas durante todo el periodo 2010--2025. Los ocupados y las horas de la GEIH se asignan a esas mismas agrupaciones usando la actividad económica reportada en la encuesta. En algunos casos, varias actividades de la GEIH se agrupan para coincidir con las categorías del valor agregado; por ejemplo, comercio, transporte y alojamiento se presentan de manera conjunta, al igual que administración pública, educación y salud. El DANE también publica el valor agregado con mayor desagregación, a 25 y 61 agrupaciones. En este informe esas aperturas se usan para entender mejor dónde se origina el dinamismo o el rezago del valor agregado, pero no para recalcular productividad laboral, porque el cruce histórico de ocupados y horas a ese nivel requeriría una homologación más fina entre CIIU Rev. 3 y CIIU Rev. 4. Los resultados, los insumos y el código de replicación están disponibles en el repositorio del proyecto: \url{https://github.com/Kin-George/CJC-Monitor}.
...
El patrón transversal entre actividades económicas refuerza la lectura de heterogeneidad. Las actividades donde más crecen los ocupados y las horas totales no son, en promedio, las mismas donde más aumenta la productividad: la correlación entre el crecimiento de los ocupados y el crecimiento del valor agregado por trabajador es -0,68, y la correlación entre el crecimiento de las horas totales y el crecimiento del valor agregado por hora es -0,67. Esto no implica que el empleo sea indeseable, sino que la absorción de trabajadores se ha concentrado parcialmente en actividades donde el valor agregado por trabajador crece menos o incluso cae. En contraste, las dos medidas de productividad se mueven casi una a una entre actividades económicas, con una correlación de 0,997, lo que indica que el ranking de desempeño productivo es muy similar si se mide por trabajador o por hora.
...
La mirada por actividad económica muestra que el reto no es solo agregado. Algunas actividades, como información y comunicaciones, agropecuario y artes, otros servicios y hogares, registraron mejoras importantes de productividad. Otras, en cambio, presentaron caídas en el valor agregado por trabajador y en el valor agregado por hora. Además, las actividades que más aumentaron sus ocupados no fueron necesariamente las que más elevaron su productividad. La apertura a 25 y 61 agrupaciones muestra que esta heterogeneidad es aún mayor cuando se observa el valor agregado con más detalle. Esto no implica que la creación de empleo sea una mala noticia, sino que la calidad productiva de esa absorción laboral importa para que el crecimiento se traduzca en mejores salarios e ingresos.
