...
\textbf{El resto del informe está organizado en cuatro secciones.} La primera presenta la metodología y la descomposición que permite separar el crecimiento del PIB entre ocupación, horas trabajadas y productividad por hora. La segunda describe la evolución agregada de la productividad laboral en Colombia. La tercera analiza las diferencias entre las doce agrupaciones sectoriales y la cuarta estudia la relación entre crecimiento de la ocupación y crecimiento de la productividad a través de sectores. El informe cierra con una breve sección de conclusiones.
