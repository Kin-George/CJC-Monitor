...
\textbf{Existe una gran dispersión en el crecimiento de la productividad entre agrupaciones de actividad económica.} Este informe no solo estudia la dinámica de la productividad agregada, sino también la productividad de las actividades económicas reportadas por el DANE a 12, 25 y 61 agrupaciones. Durante el periodo 2010--2025, actividades como información y comunicaciones alcanzaron un crecimiento anualizado del 4,5\% en el PIB por hora trabajada, mientras que actividades como explotación de minas y canteras enfrentaron una reducción anualizada del 3,1\% en su PIB por hora trabajada.
...
\textbf{Después de esta introducción, el informe está organizado en siete secciones adicionales.} La sección 2 presenta la metodología y la descomposición que permite separar el crecimiento del PIB entre ocupación, horas trabajadas y productividad por hora. La sección 3 describe la evolución agregada de la productividad laboral en Colombia. La sección 4 analiza las diferencias entre las doce agrupaciones de actividad económica. Las secciones 5 y 6 repiten el ejercicio de PIB por trabajador y PIB por hora trabajada para las aperturas de 25 y 61 agrupaciones, respectivamente. La sección 7 estudia la relación entre crecimiento de la ocupación y crecimiento de la productividad a través de actividades económicas. Finalmente, la sección 8 presenta las conclusiones.
...
\section{Productividad laboral por actividad económica: 25 agrupaciones}

La apertura a 25 agrupaciones permite mirar dentro de algunas de las grandes actividades económicas usadas en la sección anterior y repetir el ejercicio de productividad laboral con una mayor desagregación. Esta sección calcula el PIB por trabajador y el PIB por hora trabajada para cada agrupación, manteniendo la misma lógica de cruce entre cuentas nacionales y GEIH.

\input{Paper/sections/pib_geih_productividad_25_agrupaciones}

\section{Productividad laboral por actividad económica: 61 agrupaciones}

La desagregación a 61 agrupaciones ofrece una lectura todavía más fina. En este nivel aparecen actividades muy específicas que pueden quedar ocultas incluso dentro de las 25 agrupaciones. La tabla completa se presenta en formato de varias páginas y debe leerse como una aproximación descriptiva, porque en algunos casos la apertura laboral comparable de la GEIH es menos detallada que la apertura del PIB del DANE.
