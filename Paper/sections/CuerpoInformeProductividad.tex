...
\textbf{Existe una gran dispersión en el crecimiento de la productividad de las grandes ramas de actividad económica.} El presente informe no solo estudia la dinámica de la productividad agregada, también estudia la productividad de las doce agrupaciones CIIU usadas por el DANE.  Durante el periodo 2010-2015, actividades como información y comunicaciones alcanzaron un crecimiento anual del 4,5\% en el producto por hora trabajada,  mientras que actividades como la explotación de minas y canteras enfrentaron una reducción anual del 3,1\% en su producto por hora trabajada.

\textbf{Una pregunta central es si la ocupación creció en los sectores donde también creció la productividad.} Los resultados muestran que, entre 2010 y 2025, las actividades con el mayor aumento porcentual en el número de ocupados no fueron aquellas donde más creció el PIB por trabajador o el PIB por hora trabajada. Esto no necesariamente debe interpretarse como una señal de una mala asignación de los ocupados, dado que algunas de las actividades con mayor crecimiento en su productividad todavía se encuentran con una productividad laboral menor a la de otras actividades. Por esa razón,  informes posteriores del Centro Javeriano de Competitividad estudiarán con más detalle la asignación de los factores de producción entre distintas actividades económicas con el fin de estudiar las potenciales ganancias de eficiencia que se alcanzarían reduciendo las barreras que impiden la asignación de los recursos hacia sus usos más eficientes.
