...
\textbf{La dimensión sectorial es central para entender la productividad.} La productividad agregada puede ocultar dinámicas muy distintas entre actividades económicas. En algunos sectores crece el valor agregado por trabajador y por hora; en otros aumenta la ocupación sin aumentos comparables de productividad. Por esa razón, este informe no se limita al agregado nacional. También desagrega el crecimiento del PIB, los ocupados, las horas trabajadas y la productividad para las doce agrupaciones CIIU usadas por el DANE.
