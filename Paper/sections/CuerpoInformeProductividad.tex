...
Este primer informe debe leerse como una primera pieza dentro de una serie más amplia de análisis del Centro Javeriano de Competitividad sobre productividad en Colombia. En esta entrega se documenta la relación entre PIB, ocupación, horas y actividad económica. Informes posteriores podrán otras dimensiones de la productividad como la formalidad, el tamaño de la empresa o el capital humano, así como la evolución de la productividad a través de actividades económicas aún más desagregadas y a través de las diferentes regiones del país.
