...
La productividad laboral ocupa un lugar central en cualquier agenda de desarrollo porque conecta tres discusiones que con frecuencia se tratan por separado: crecimiento económico, calidad del empleo y competitividad empresarial. Una economía puede aumentar el número de ocupados y, aun así, enfrentar dificultades para elevar de manera sostenida los salarios, la rentabilidad de las firmas y los ingresos públicos si el valor agregado generado por cada trabajador o por cada hora trabajada crece lentamente. Por esa razón, la productividad no es un indicador abstracto de eficiencia: es una condición para que el crecimiento se traduzca en mejores ingresos, mayor capacidad de inversión y más espacio fiscal para financiar bienes públicos.

En Colombia, esta discusión es especialmente relevante. Durante los últimos quince años el país logró expandir de forma importante la ocupación, pero persiste la pregunta sobre la calidad productiva de esa expansión. No basta con saber si hay más personas trabajando; también es necesario entender si esas personas están ubicadas en actividades donde el valor agregado por trabajador aumenta, si las horas trabajadas se usan de manera más productiva y si la estructura sectorial del empleo favorece o limita la convergencia hacia niveles más altos de ingreso. En otras palabras, la pregunta de fondo no es solo cuánto empleo genera la economía, sino cuánto valor produce ese empleo.

Este informe parte de esa motivación. Su objetivo es medir la evolución de la productividad laboral en Colombia entre 2010 y 2025 combinando dos fuentes: el PIB trimestral del DANE por el enfoque de producción y la información de ocupados y horas trabajadas de la GEIH. A partir de esa combinación se construyen dos indicadores complementarios: el PIB por trabajador, que resume el valor agregado generado por persona ocupada, y el PIB por hora trabajada, que permite aproximar la productividad por unidad efectiva de tiempo laboral. La distinción es importante porque el número de ocupados y las horas promedio no necesariamente se mueven en la misma dirección.

El énfasis del informe está en la dimensión sectorial. La productividad agregada puede ocultar trayectorias muy distintas: sectores que absorben empleo pero pierden productividad, sectores pequeños con fuertes ganancias de valor agregado por hora, y ramas de alta productividad inicial que reducen su ventaja relativa. Para una agenda de política pública y competitividad empresarial, esta heterogeneidad es fundamental. Las intervenciones para elevar la productividad no son las mismas si el problema principal está en la asignación de trabajadores entre sectores, en la baja productividad dentro de sectores intensivos en empleo o en la pérdida de dinamismo de ramas tradicionalmente productivas.

El informe debe leerse como una primera pieza dentro de una serie más amplia de análisis del Centro Javeriano de Competitividad sobre productividad en Colombia. En esta entrega se documenta la relación entre PIB, ocupación, horas y estructura sectorial. Informes posteriores podrán profundizar en mecanismos específicos, como formalidad, tamaño de empresa, capital humano, inversión, tecnología o productividad dentro de ramas industriales. El punto de partida, sin embargo, es deliberadamente amplio: establecer qué tan rápido ha crecido la productividad laboral, dónde se concentra el empleo y qué sectores están convirtiendo mejor el trabajo en valor agregado.
