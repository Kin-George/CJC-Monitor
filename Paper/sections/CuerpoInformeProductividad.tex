...
\[
\text{PIB} = \left(\frac{\text{PIB}}{\text{Horas}}\right) \times \left(\frac{\text{Horas}}{\text{Ocupados}}\right) \times \text{Ocupados}.
\]
...
El Cuadro \ref{tab:ocupados_horas_resumen} resume esta descomposición básica. Presenta, junto al PIB real, el número de ocupados, las horas semanales promedio por trabajador, el PIB por trabajador y el PIB por hora trabajada.
