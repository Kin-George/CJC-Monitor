\begin{table}[htbp]
  ...
  \begin{tabular}{p{0.30\textwidth}p{0.40\textwidth}cc}
    ...
    Diegmann et al. (2026) & Worker controls & 0.036 & n.a. \\
    \midrule
    Colombia (GEIH) & No controls & 0.203*** & (0.019) \\
    Colombia (GEIH) & Worker controls - Full sample & 0.071*** & (0.013) \\
    Colombia (GEIH) & Worker controls - Formal workers & 0.026** & (0.011) \\
    Colombia (GEIH) & Worker controls - Informal workers & 0.130*** & (0.015) \\
    \bottomrule
  \end{tabular}
  \vspace{0.3em}
