...
\subsection{Arte, entretenimiento y otros servicios}

Esta agrupación corresponde al nivel laboral comparable para Arte, entretenimiento y otros servicios.

\begin{table}[H]
\centering
\caption{Arte, entretenimiento y otros servicios: PIB, ocupados, horas y productividad laboral, 2010--2025}
