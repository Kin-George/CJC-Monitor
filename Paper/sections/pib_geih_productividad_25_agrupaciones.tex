...
\subsection{Edificaciones; Obras civiles; Actividades especializadas de construcción}

Esta agrupación corresponde al nivel laboral comparable para Edificaciones; Obras civiles; Actividades especializadas de construcción.

\begin{table}[H]
\centering
\caption{Edificaciones; Obras civiles; Actividades especializadas de construcción: PIB, ocupados, horas y productividad laboral, 2010--2025}
\label{tab:agg25_f01_f02_f03_productividad}
\small
\begin{tabular}{lrrr}
\toprule
Indicador & 2010 & 2025 & Crec. anual \\
\midrule
PIB real  (Billones de pesos de 2015) & 40,3 & 41,5 & 0,19\% \\
...
\textbf{Frente al agregado nacional, la comparación variable por variable muestra diferencias relevantes.} El PIB real de la actividad registró una tasa anualizada de 0,19\%, por debajo del agregado (3,16\%). La ocupación en la actividad registró una tasa anualizada de 3,39\%, por encima del agregado (2,09\%). El PIB por trabajador registró una tasa anualizada de -3,10\%, por debajo del agregado (1,05\%). Las horas semanales por trabajador registraron una tasa anualizada de -0,46\%, muy cerca de la caída agregada (-0,45\%). El PIB por hora trabajada registró una tasa anualizada de -2,65\%, por debajo del agregado (1,51\%).

\textbf{En niveles de 2025, el tamaño relativo y la productividad de la actividad económica también importan.} La actividad representó 4,1\% del PIB real agregado, con 41,5 billones de pesos de 2015, y concentró 6,9\% de los ocupados, con 1,6 millones de personas. El PIB por trabajador fue 26,3 millones de pesos de 2015 por ocupado, por debajo del agregado (44,5 millones). Las horas semanales por trabajador fueron 45,7, muy cerca del agregado (43,7). El PIB por hora trabajada fue 11,1 mil pesos de 2015 por hora, por debajo del agregado (19,6 mil).
