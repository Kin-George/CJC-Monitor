...
Cultivos y apoyo agropecuario & 19,9 & 2,74\% & 9,1 & 3,19\% \\
Ganadería & 19,9 & 2,74\% & 9,1 & 3,19\% \\
Café & 19,9 & 2,74\% & 9,1 & 3,19\% \\
\bottomrule
\end{tabular}
\caption*{\footnotesize Nota: PIB por trabajador en millones de pesos constantes de 2015; PIB por hora en miles de pesos constantes de 2015. Cuando la GEIH no separa ocupados y horas al mismo nivel de las cuentas nacionales, se asignan proporcionalmente al PIB dentro del grupo laboral comparable. Fuente: cálculos propios con DANE y GEIH.}
\end{table}

En esta apertura, el mayor crecimiento del PIB por trabajador se observa en Silvicultura (5,15\%), mientras que el menor se registra en Cultivos y apoyo agropecuario, Ganadería y Café (2,74\%). Por hora trabajada, el mejor desempeño corresponde a Silvicultura (6,27\%) y el más rezagado a Cultivos y apoyo agropecuario, Ganadería y Café (3,19\%).
...
Actividad económica & PIB/trab. 2025 & Crec. & PIB/hora 2025 & Crec. \\
\midrule
Carbón & 308,0 & -2,44\% & 124,1 & -1,90\% \\
Petróleo, gas y apoyo conexo & 308,0 & -2,44\% & 124,1 & -1,90\% \\
Apoyo a otras actividades mineras & 308,0 & -2,44\% & 124,1 & -1,90\% \\
Minerales metalíferos & 22,1 & -5,13\% & 9,4 & -4,68\% \\
Otras minas y canteras & 22,1 & -5,13\% & 9,4 & -4,68\% \\
\bottomrule
\end{tabular}
\caption*{\footnotesize Nota: PIB por trabajador en millones de pesos constantes de 2015; PIB por hora en miles de pesos constantes de 2015. Cuando la GEIH no separa ocupados y horas al mismo nivel de las cuentas nacionales, se asignan proporcionalmente al PIB dentro del grupo laboral comparable. Fuente: cálculos propios con DANE y GEIH.}
\end{table}

En esta apertura, el mayor crecimiento del PIB por trabajador se observa en Carbón; Petróleo, gas y apoyo conexo; y Apoyo a otras actividades mineras (-2,44\%), mientras que el menor se registra en Minerales metalíferos y Otras minas y canteras (-5,13\%). Por hora trabajada, el mejor desempeño corresponde a Carbón; Petróleo, gas y apoyo conexo; y Apoyo a otras actividades mineras (-1,90\%) y el más rezagado a Minerales metalíferos y Otras minas y canteras (-4,68\%).
...
Actividad económica & PIB/trab. 2025 & Crec. & PIB/hora 2025 & Crec. \\
\midrule
Obras civiles & 26,3 & -3,10\% & 11,1 & -2,65\% \\
Actividades especializadas de construcción & 26,3 & -3,10\% & 11,1 & -2,65\% \\
Edificaciones & 26,3 & -3,10\% & 11,1 & -2,65\% \\
\bottomrule
\end{tabular}
\caption*{\footnotesize Nota: PIB por trabajador en millones de pesos constantes de 2015; PIB por hora en miles de pesos constantes de 2015. Fuente: cálculos propios con DANE y GEIH.}
\end{table}
