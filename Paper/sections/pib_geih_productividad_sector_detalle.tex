...
Cultivos agrícolas & 20,5 & 2,24\% & 9,6 & 2,61\% \\
...
\textbf{En crecimiento de la productividad de cada una de las subactividades del sector agropecuario supera el crecimiento de la productividad del resto de la economía.} En esta apertura, el mayor crecimiento del PIB por trabajador se observa en Silvicultura (5,15\%), muy por encima del crecimiento agregado del PIB por trabajador (1,05\%); el menor se registra en Café (1,75\%), por encima del crecimiento agregado del PIB por trabajador (1,05\%). Por hora trabajada, el mejor desempeño corresponde a Silvicultura (6,27\%), muy por encima del crecimiento agregado del PIB por hora trabajada (1,51\%); el más rezagado corresponde a Café (1,98\%), por encima del crecimiento agregado del PIB por hora trabajada (1,51\%).
...
\textbf{El balance de la apertura de la manufactura es heterogéneo: dos de las seis subactividades superan el crecimiento agregado del PIB por trabajador y por hora trabajada, mientras las demás quedan rezagadas.} En esta apertura, el mayor crecimiento del PIB por trabajador se observa en Alimentos, bebidas y tabaco (1,60\%), por encima del crecimiento agregado del PIB por trabajador (1,05\%); el menor se registra en Muebles y otras manufactureras (-1,31\%), muy por debajo del crecimiento agregado del PIB por trabajador (1,05\%). Por hora trabajada, el mejor desempeño corresponde a Madera, papel e impresión (2,21\%), por encima del crecimiento agregado del PIB por hora trabajada (1,51\%); el más rezagado corresponde a Muebles y otras manufactureras (-1,06\%), muy por debajo del crecimiento agregado del PIB por hora trabajada (1,51\%).

\subsection{Servicios públicos}

\textbf{La actividad de servicios públicos incluye electricidad, gas y vapor y agua, saneamiento y desechos.} En 2025 la actividad de servicios públicos representó 3,0\% del PIB, con 30,3 billones de pesos de 2015, y concentró 1,3\% de los ocupados, con 0,3 millones de personas. El PIB por trabajador fue 99,5 millones de pesos de 2015 por ocupado, por encima del agregado (44,5 millones). Las horas semanales por trabajador fueron 44,0, muy cerca del agregado (43,7). El PIB por hora trabajada fue 43,5 mil pesos de 2015 por hora, por encima del agregado (19,6 mil).
...
\textbf{El balance de la apertura de las actividades profesionales y administrativas es claramente negativo: todas las subactividades registran caídas de productividad y ninguna alcanza el crecimiento agregado.} En esta apertura, el mayor crecimiento del PIB por trabajador se observa en Servicios administrativos y de apoyo (-1,61\%), muy por debajo del crecimiento agregado del PIB por trabajador (1,05\%); el menor se registra en Profesionales, científicas y técnicas (-2,16\%), muy por debajo del crecimiento agregado del PIB por trabajador (1,05\%). Por hora trabajada, el mejor desempeño corresponde a Servicios administrativos y de apoyo (-1,20\%), muy por debajo del crecimiento agregado del PIB por hora trabajada (1,51\%); el más rezagado corresponde a Profesionales, científicas y técnicas (-1,86\%), muy por debajo del crecimiento agregado del PIB por hora trabajada (1,51\%).
...
Actividad económica & PIB/trab. 2025 & Crec. & PIB/hora 2025 & Crec. \\
\midrule
Arte, entretenimiento y recreación & 32,8 & 5,95\% & 16,0 & 5,89\% \\
...
\textbf{El balance de la apertura de la agrupación de arte, recreación y hogares como empleadores es favorable: todas las subactividades superan el crecimiento agregado tanto en PIB por trabajador como en PIB por hora trabajada.} En esta apertura, el mayor crecimiento del PIB por trabajador se observa en Arte, entretenimiento y recreación (5,95\%), muy por encima del crecimiento agregado del PIB por trabajador (1,05\%); el menor se registra en Hogares como empleadores (2,63\%), muy por encima del crecimiento agregado del PIB por trabajador (1,05\%). Por hora trabajada, el mejor desempeño corresponde a Arte, entretenimiento y recreación (5,89\%), muy por encima del crecimiento agregado del PIB por hora trabajada (1,51\%); el más rezagado corresponde a Hogares como empleadores (3,49\%), muy por encima del crecimiento agregado del PIB por hora trabajada (1,51\%).
