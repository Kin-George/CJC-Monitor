...
Ocupados (Millones) & 1,6 & 2,0 & 1,17\% \\
PIB por trabajador (Millones de pesos de 2015) & 9,3 & 24,2 & 6,56\% \\
Horas semanales por trabajador & 42,0 & 39,9 & -0,34\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 4,3 & 11,6 & 6,93\% \\
\bottomrule
\end{tabular}
\end{table}

\textbf{El crecimiento de la productividad de la agrupación de arte, recreación y hogares como empleadores fue superior al crecimiento de la productividad agregada.} Entre 2010 y 2025 el PIB de la agrupación de arte, recreación y hogares como empleadores registró un crecimiento anualizado del 7,81\%, muy por encima del agregado (3,16\%). Los ocupados en la actividad registraron un crecimiento anual del 1,17\%, por debajo del agregado (2,09\%). El PIB por trabajador registró un crecimiento anual del 6,56\%, muy por encima del crecimiento del PIB por trabajador de toda la economía (1,05\%). Las horas semanales por trabajador registraron una caída anual del 0,34\%, muy cerca de la caída agregada (-0,45\%). El PIB por hora trabajada registró un crecimiento anual del 6,93\%, muy por encima del crecimiento del PIB por hora trabajada de toda la economía (1,51\%).
...
Actividad económica & PIB/trab. 2025 & Crec. & PIB/hora 2025 & Crec. \\
\midrule
Arte, entretenimiento y recreación & 32,8 & 7,32\% & 16,0 & 7,28\% \\
...
\textbf{El balance de la apertura de la agrupación de arte, recreación y hogares como empleadores es favorable: todas las subactividades superan el crecimiento agregado tanto en PIB por trabajador como en PIB por hora trabajada.} En esta apertura, el mayor crecimiento del PIB por trabajador se observa en Arte, entretenimiento y recreación (7,32\%), muy por encima del crecimiento agregado del PIB por trabajador (1,05\%); el menor se registra en Hogares como empleadores (2,63\%), muy por encima del crecimiento agregado del PIB por trabajador (1,05\%). Por hora trabajada, el mejor desempeño corresponde a Arte, entretenimiento y recreación (7,28\%), muy por encima del crecimiento agregado del PIB por hora trabajada (1,51\%); el más rezagado corresponde a Hogares como empleadores (3,49\%), muy por encima del crecimiento agregado del PIB por hora trabajada (1,51\%).
