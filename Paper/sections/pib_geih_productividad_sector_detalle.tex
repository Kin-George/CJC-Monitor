...
\textbf{El balance de la apertura de la manufactura es heterogéneo: dos de las seis subactividades superan el crecimiento agregado del PIB por trabajador y dos de las seis subactividades superan el crecimiento agregado del PIB por hora trabajada, mientras otras quedan rezagadas.} En esta apertura, el mayor crecimiento del PIB por trabajador se observa en Alimentos, bebidas y tabaco (1,60\%), por encima del crecimiento agregado del PIB por trabajador (1,05\%); el menor se registra en Muebles y otras manufactureras (-1,31\%), muy por debajo del crecimiento agregado del PIB por trabajador (1,05\%). Por hora trabajada, el mejor desempeño corresponde a Madera, papel e impresión (2,21\%), por encima del crecimiento agregado del PIB por hora trabajada (1,51\%); el más rezagado corresponde a Muebles y otras manufactureras (-1,06\%), muy por debajo del crecimiento agregado del PIB por hora trabajada (1,51\%).
...
\textbf{El balance de la apertura de la agrupación de comercio, transporte y alojamiento es heterogéneo: una de las tres subactividades supera el crecimiento agregado del PIB por trabajador y una de las tres subactividades supera el crecimiento agregado del PIB por hora trabajada, mientras otras quedan rezagadas.} En esta apertura, el mayor crecimiento del PIB por trabajador se observa en Comercio y reparación (2,75\%), muy por encima del crecimiento agregado del PIB por trabajador (1,05\%); el menor se registra en Alojamiento y comida (-1,08\%), muy por debajo del crecimiento agregado del PIB por trabajador (1,05\%). Por hora trabajada, el mejor desempeño corresponde a Comercio y reparación (3,16\%), muy por encima del crecimiento agregado del PIB por hora trabajada (1,51\%); el más rezagado corresponde a Alojamiento y comida (-0,42\%), muy por debajo del crecimiento agregado del PIB por hora trabajada (1,51\%).
...
\textbf{La agrupación de arte, entretenimiento y recreación reúne actividades artísticas, de entretenimiento, recreación y otros servicios, junto con los hogares como empleadores.} En 2025 la agrupación de arte, entretenimiento y recreación representó 4,6\% del PIB, con 47,2 billones de pesos de 2015, y concentró 8,5\% de los ocupados, con 2,0 millones de personas. El PIB por trabajador fue 24,2 millones de pesos de 2015 por ocupado, por debajo del agregado (44,5 millones). Las horas semanales por trabajador fueron 39,9, por debajo del agregado (43,7). El PIB por hora trabajada fue 11,6 mil pesos de 2015 por hora, por debajo del agregado (19,6 mil).
...
Actividad económica & PIB/trab. 2025 & Crec. & PIB/hora 2025 & Crec. \\
\midrule
Arte, entretenimiento, recreación y otros servicios & 32,8 & 5,95\% & 16,0 & 5,89\% \\
...
\textbf{El balance de la apertura de arte, entretenimiento y recreación es favorable: todas las subactividades superan el crecimiento agregado tanto en PIB por trabajador como en PIB por hora trabajada.} En esta apertura, el mayor crecimiento del PIB por trabajador se observa en Arte, entretenimiento, recreación y otros servicios (5,95\%), muy por encima del crecimiento agregado del PIB por trabajador (1,05\%); el menor se registra en Hogares como empleadores (2,63\%), muy por encima del crecimiento agregado del PIB por trabajador (1,05\%). Por hora trabajada, el mejor desempeño corresponde a Arte, entretenimiento, recreación y otros servicios (5,89\%), muy por encima del crecimiento agregado del PIB por hora trabajada (1,51\%); el más rezagado corresponde a Hogares como empleadores (3,49\%), muy por encima del crecimiento agregado del PIB por hora trabajada (1,51\%).
