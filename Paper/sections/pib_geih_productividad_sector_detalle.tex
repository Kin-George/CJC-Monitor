...
En esta apertura, el mayor crecimiento del PIB por trabajador se observa en Silvicultura (5,15\%), mientras que el menor se registra en Café (1,75\%). Por hora trabajada, el mejor desempeño corresponde a Silvicultura (6,27\%) y el más rezagado a Café (1,98\%).
