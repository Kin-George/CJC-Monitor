...
\subsection{Quindío}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Quindío creció 4,61\% anual.} El PIB por trabajador creció 3,78\% anual, mientras que las horas semanales por trabajador cambiaron -0,79\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 48,2 & 43,1 & -0,79\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 8,0 & 15,1 & 4,61\% \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Caquetá}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Caquetá creció 4,18\% anual.} El PIB por trabajador creció 3,71\% anual, mientras que las horas semanales por trabajador cambiaron -0,46\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 48,7 & 45,7 & -0,46\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 5,9 & 10,5 & 4,18\% \\
\bottomrule
\end{tabular}
\end{table}
...
\subsection{Chocó}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Chocó creció 3,19\% anual.} El PIB por trabajador creció 2,95\% anual, mientras que las horas semanales por trabajador cambiaron -0,23\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 47,6 & 46,1 & -0,23\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 7,7 & 11,9 & 3,19\% \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Caldas}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Caldas creció 2,56\% anual.} El PIB por trabajador creció 2,14\% anual, mientras que las horas semanales por trabajador cambiaron -0,41\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 47,9 & 45,2 & -0,41\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 10,9 & 15,6 & 2,56\% \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Valle del Cauca}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Valle del Cauca creció 2,49\% anual.} El PIB por trabajador creció 2,15\% anual, mientras que las horas semanales por trabajador cambiaron -0,33\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 46,8 & 44,7 & -0,33\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 16,6 & 23,5 & 2,49\% \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Bogotá D.C. creció 2,43\% anual.} El PIB por trabajador creció 1,98\% anual, mientras que las horas semanales por trabajador cambiaron -0,44\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 48,2 & 45,3 & -0,44\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 20,4 & 28,6 & 2,43\% \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Bolívar}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Bolívar creció 2,34\% anual.} El PIB por trabajador creció 1,69\% anual, mientras que las horas semanales por trabajador cambiaron -0,63\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 48,0 & 43,9 & -0,63\% \\
...
\subsection{Tolima}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Tolima creció 2,15\% anual.} El PIB por trabajador creció 2,04\% anual, mientras que las horas semanales por trabajador cambiaron -0,10\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 46,1 & 45,5 & -0,10\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 12,6 & 16,9 & 2,15\% \\
\bottomrule
\end{tabular}
\end{table}
...
\subsection{Nariño}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Nariño creció 1,91\% anual.} El PIB por trabajador creció 0,97\% anual, mientras que las horas semanales por trabajador cambiaron -0,92\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 42,7 & 37,5 & -0,92\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 7,0 & 9,1 & 1,91\% \\
\bottomrule
\end{tabular}
\end{table}
...
\subsection{Boyacá}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Boyacá creció 1,42\% anual.} El PIB por trabajador creció 1,16\% anual, mientras que las horas semanales por trabajador cambiaron -0,26\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 41,9 & 40,4 & -0,26\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 18,5 & 22,6 & 1,42\% \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Norte de Santander}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Norte de Santander creció 1,40\% anual.} El PIB por trabajador creció 1,23\% anual, mientras que las horas semanales por trabajador cambiaron -0,17\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
PIB por hora trabajada (Miles de pesos de 2015) & 8,3 & 10,0 & 1,40\% \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Magdalena}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Magdalena creció 0,87\% anual.} El PIB por trabajador creció 0,16\% anual, mientras que las horas semanales por trabajador cambiaron -0,71\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 49,4 & 44,7 & -0,71\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 9,1 & 10,3 & 0,87\% \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Atlántico}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Atlántico creció 0,84\% anual.} El PIB por trabajador creció 0,46\% anual, mientras que las horas semanales por trabajador cambiaron -0,38\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 47,4 & 45,0 & -0,38\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 14,2 & 16,0 & 0,84\% \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Cesar}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Cesar creció 0,55\% anual.} El PIB por trabajador creció -0,03\% anual, mientras que las horas semanales por trabajador cambiaron -0,58\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 49,1 & 45,2 & -0,58\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 12,8 & 13,8 & 0,55\% \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Meta}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Meta creció 0,54\% anual.} El PIB por trabajador creció 0,05\% anual, mientras que las horas semanales por trabajador cambiaron -0,49\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 50,2 & 46,8 & -0,49\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 24,0 & 25,9 & 0,54\% \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Huila}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Huila creció 0,10\% anual.} El PIB por trabajador creció -0,13\% anual, mientras que las horas semanales por trabajador cambiaron -0,23\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 44,2 & 42,7 & -0,23\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 14,0 & 14,2 & 0,10\% \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Cundinamarca}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de Cundinamarca creció -0,16\% anual.} El PIB por trabajador creció -0,32\% anual, mientras que las horas semanales por trabajador cambiaron -0,17\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 45,8 & 44,7 & -0,17\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 17,8 & 17,4 & -0,16\% \\
\bottomrule
\end{tabular}
\end{table}

\subsection{La Guajira}
\textbf{Entre 2010 y 2024pr, el PIB por hora trabajada de La Guajira creció -0,52\% anual.} El PIB por trabajador creció -0,80\% anual, mientras que las horas semanales por trabajador cambiaron -0,28\% anual. Esta diferencia muestra si la productividad medida por trabajador se mueve en línea con la productividad por hora o si está afectada por cambios en la intensidad horaria.
\begin{table}[H]
\centering
...
Horas semanales por trabajador & 44,7 & 43,0 & -0,28\% \\
PIB por hora trabajada (Miles de pesos de 2015) & 11,9 & 11,1 & -0,52\% \\
\bottomrule
\end{tabular}
\end{table}
