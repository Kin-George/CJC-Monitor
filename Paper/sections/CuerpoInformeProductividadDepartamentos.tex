...
\textbf{La a productividad refleja condiciones que no son iguales en todo el país.} La geografía, la infraestructura, la formación de los trabajadores, la informalidad, la conectividad y la capacidad institucional cambian de manera importante entre departamentos. Por eso, dos territorios pueden aumentar tener trayectorias muy distintas de productividad.

\textbf{El objetivo de este informe es medir la evolución de la productividad laboral departamental en Colombia entre 2010 y 2024.} Para ello se combina el Producto Interno Bruto departamental reportado del DANE, expresado en pesos constantes de 2015, con ocupados y horas trabajadas de la Gran Encuesta Integrada de Hogares (GEIH). 

\textbf{El informe está organizado en siete secciones, incluyendo esta introducción.} La sección 2 presenta la metodología y las fuentes. La sección 3 compara la productividad laboral de los departamentos. La sección 4 analiza la relación entre productividad y remuneración laboral. La sección 5 distingue entre niveles y crecimientos de la productividad usando una gráfica de cuadrantes y un ejercicio descriptivo de convergencia. La sección 6 analiza la relación entre crecimiento del trabajo y crecimiento de la productividad. La sección 7 presenta conclusiones. El apéndice incluye el detalle de cada departamento.

\section{Metodología}

\textbf{La medición combina cuentas nacionales departamentales y microdatos de la GEIH.} El numerador corresponde al PIB departamental real del DANE, tomado del anexo \textit{Producto Interno Bruto por departamento}, en series encadenadas de volumen con año de referencia 2015. El denominador se construye con la GEIH. El número de ocupados corresponde al promedio anual de personas ocupadas, calculado con el factor de expansión de la encuesta. Las horas trabajadas se calculan multiplicando el número de ocupados por el promedio ponderado de horas semanales entre los ocupados que reportan horas válidas, y luego anualizando ese resultado por 52 semanas. De esta manera, los ocupados que no reportan horas no se tratan implícitamente como trabajadores con cero horas, sino que se les asigna el promedio observado del respectivo departamento y año.

\textbf{La comparación con remuneración laboral también se construye con la GEIH.} La remuneración mensual se calcula a partir del ingreso laboral por hora, las horas semanales trabajadas y el factor de expansión de la encuesta. La remuneración laboral mensual total se calcula entre los ocupados con ingreso y horas válidas. Luego, para mantener la comparación con el PIB por trabajador, ese total se divide por el número total de ocupados del departamento.
...
\input{Paper/sections/pib_geih_productividad_departamento_ranking_niveles}
...
\section{Productividad y remuneración laboral}

\textbf{La productividad importa, entre otras razones, porque puede sostener mejores remuneraciones laborales.} Por eso, después de medir las diferencias departamentales en PIB por trabajador, conviene preguntar si los departamentos donde se produce más por ocupado son también aquellos donde los trabajadores reciben una mayor remuneración. La lectura debe hacerse en dos pasos: primero comparando los niveles de productividad y remuneración en 2024, y luego comparando el crecimiento de ambas variables entre 2010 y 2024pr.

\input{Paper/sections/pib_geih_productividad_departamento_remuneracion_niveles}

\textbf{El ranking de niveles de remuneración confirma la centralidad de Bogotá D.C., pero también muestra diferencias frente al ranking de productividad.} Bogotá D.C. ocupa el primer lugar tanto en remuneración por trabajador como en PIB por trabajador. Antioquia y Caldas aparecen en el segundo y tercer lugar de remuneración, aunque ocupan posiciones más bajas en PIB por trabajador. En el otro extremo, La Guajira, Sucre, Córdoba, Nariño y Cauca se ubican entre los departamentos con menores niveles de remuneración por trabajador.
...
\textbf{El mapa muestra que las diferencias departamentales tienen una geografía clara.} Los tonos más oscuros de productividad se concentran en Bogotá D.C., Meta, Santander, Valle del Cauca y Antioquia, mientras que la remuneración por trabajador se concentra con más fuerza en Bogotá D.C. y Antioquia. La comparación visual refuerza un punto central del informe: la geografía de la productividad y la geografía de la remuneración se parecen, pero no son idénticas.
...
\textbf{La Figura \ref{fig:pib_geih_productividad_departamento_remuneracion} muestra una asociación clara entre productividad y remuneración.} La correlación entre el PIB por trabajador y la remuneración por trabajador es cercana a 0,8 entre los 24 departamentos comparables. Sin embargo, la dispersión alrededor de la línea de tendencia confirma que los niveles de remuneración también reflejan otros factores: composición sectorial, informalidad, calificación de los trabajadores, estructura empresarial y condiciones locales del mercado laboral.

\textbf{Los departamentos más alejados de la recta son especialmente informativos.} Por encima de la relación promedio aparecen Bogotá D.C., Caldas, Antioquia, Norte de Santander, Quindío, Caquetá y Risaralda: para su nivel de PIB por trabajador, registran una remuneración por trabajador mayor a la que sugiere la tendencia entre departamentos. Por debajo de la recta aparecen Bolívar, Santander, Meta, La Guajira y Boyacá: para su nivel de PIB por trabajador, registran una remuneración menor a la que sugiere la relación promedio. Esto no debe leerse como evidencia directa de que unos departamentos paguen demasiado y otros paguen muy poco. Más bien señala que la conexión entre productividad y remuneración pasa por la estructura productiva y laboral de cada territorio. En particular, los casos de Meta, Santander y Bolívar son importantes porque combinan niveles altos de PIB por trabajador con remuneraciones relativamente más bajas frente a la tendencia.
...
\textbf{La misma lectura por cuadrantes muestra que la remuneración tiene una geografía distinta a la productividad.} Bogotá D.C. y Caldas combinan niveles altos de remuneración con crecimientos superiores al agregado. Antioquia, Santander y Valle del Cauca mantienen remuneraciones altas, pero con crecimientos por debajo del agregado. En cambio, Cundinamarca, Meta y Risaralda aparecen como aceleradores de remuneración: no están por encima del nivel agregado en 2024pr, pero registraron aumentos superiores al promedio durante el periodo. Como muestra la Figura \ref{fig:geih_remuneracion_departamento_mapa_cuadrantes}, esta clasificación no se distribuye de manera aleatoria en el territorio: buena parte del norte y del suroccidente aparece entre los rezagados, mientras que los aceleradores se concentran principalmente en el centro del país. Esta diferencia frente a los cuadrantes de productividad refuerza que producir más por trabajador y remunerar más al trabajador están relacionados, pero no son el mismo fenómeno.
...
\textbf{Hay señales de convergencia territorial, pero estas son parciales y desiguales.} Los departamentos que partieron con menores niveles de productividad tendieron, en promedio, a crecer más rápido. Este patrón se observa en Quindío, Caquetá, Risaralda y Chocó. Sin embargo, la relación no es mecánica: Bogotá D.C. partió de un nivel alto y siguió creciendo por encima del agregado, mientras que La Guajira partió de un nivel bajo y registró una caída en productividad. Por eso, el ejercicio sugiere convergencia descriptiva, pero no permite concluir que las brechas territoriales se estén cerrando de manera generalizada.
...
\textbf{Los departamentos más productivos tienden a tener mayores remuneraciones, pero la relación no es automática.} La comparación entre PIB por trabajador y remuneración por trabajador muestra una asociación positiva importante en niveles, pero una relación más débil cuando se comparan sus crecimientos. Esto sugiere que los aumentos de productividad no se traducen de manera inmediata ni homogénea en aumentos de remuneración. Las diferencias entre ambos rankings también indican que la remuneración laboral depende de otros factores, como la composición sectorial, la informalidad, la calificación de los trabajadores y las condiciones locales del mercado laboral.
