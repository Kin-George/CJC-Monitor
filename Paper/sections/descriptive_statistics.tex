...
Figure~\ref{fig:income-education-comparison} and
Table~\ref{tab:descriptive-education-endpoints-2025} summarize the relationship
between education and firm size within each education group. Among workers with
preschool or less, employment is heavily concentrated in solo work: 65.2 percent
are solo workers and only 1.4 percent are in firms with 101 or more workers.
Even within this low-education group, mean hourly income is 2.1 times higher in
101+ firms than in solo work. The primary-education panel shows a similar
pattern: 55.5 percent of workers are solo, only 4.9 percent are in 101+ firms,
and the 101+-to-solo wage ratio is 1.8. Among workers with secondary education,
employment is less concentrated at the bottom but still tilted toward smaller
firms: 37.1 percent are solo workers and 18.5 percent are in 101+ firms; the
large-firm wage ratio is 1.5. Higher education reverses the employment pattern:
only 17.3 percent of workers are solo, while 47.3 percent are in 101+ firms.
The large-firm advantage remains visible within this group as well, with a
101+-to-solo wage ratio of 1.7.
