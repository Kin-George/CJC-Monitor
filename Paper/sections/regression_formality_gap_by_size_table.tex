\begin{table}[htbp]
  ...
  \begin{tabular}{lcccc}
    ...
    \midrule
    Solo & 0.524*** & 68.8\% & [49.3, 90.9] & $<0.001$ \\
     & (0.063) &  &  &  \\
    2-3 & 0.348*** & 41.6\% & [36.7, 46.7] & $<0.001$ \\
     & (0.018) &  &  &  \\
    4-5 & 0.205*** & 22.8\% & [14.5, 31.7] & $<0.001$ \\
     & (0.036) &  &  &  \\
    6-10 & 0.155*** & 16.7\% & [9.9, 24.0] & $<0.001$ \\
     & (0.031) &  &  &  \\
    11-19 & 0.149*** & 16.1\% & [10.8, 21.7] & $<0.001$ \\
     & (0.024) &  &  &  \\
    20-30 & 0.145*** & 15.6\% & [11.5, 19.8] & $<0.001$ \\
     & (0.018) &  &  &  \\
    31-50 & 0.165*** & 17.9\% & [14.6, 21.2] & $<0.001$ \\
     & (0.014) &  &  &  \\
    51-100 & 0.181*** & 19.9\% & [15.6, 24.3] & $<0.001$ \\
     & (0.019) &  &  &  \\
    101+ & 0.341*** & 40.6\% & [29.3, 52.8] & $<0.001$ \\
     & (0.043) &  &  &  \\
    \bottomrule
  \end{tabular}
  \vspace{0.3em}
