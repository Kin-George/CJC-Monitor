...
\begin{figure}[p]
  ...
  \caption{Mean real hourly income by firm size and education, 2008 and 2025; bubble size shows each firm-size category's employment share within the corresponding education-year}
...
\begin{figure}[p]
  ...
  \caption{Mean real hourly income by firm size and sector, 2008 and 2025; bubble size shows each firm-size category's employment share within the corresponding sector-year}
