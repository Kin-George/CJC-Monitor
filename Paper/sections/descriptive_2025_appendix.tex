...
employment shares, raw firm-size wage premia, and worker composition. Figure
\ref{fig:income-sector-comparison} then splits the 2008--2025 endpoint wage
...
sector panels show that this pattern is not mechanically driven by a single
activity, even though the magnitude of the gradient varies across sectors.
