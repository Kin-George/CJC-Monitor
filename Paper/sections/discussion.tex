...
One reading we explicitly do not draw is a direct monopsony test. The recent
literature on firm wage setting emphasizes that employers may have wage-setting
power, but monopsony concerns markdowns relative to marginal products and
firm-specific labor-supply elasticities, neither of which is observed in the
GEIH \citep{Card2022}. A positive, robust firm-size premium is therefore
compatible with monopsonistic labor markets, but it is not evidence for or
against monopsony by itself. In this paper, the premium is more directly
informative about productivity-driven pay differences, rent sharing, worker
sorting, and segmentation, consistent with the firm-centric view of wage
