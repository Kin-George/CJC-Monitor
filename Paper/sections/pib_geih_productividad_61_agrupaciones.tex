...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{Paper/figures/fig_pib_geih_productividad_sector_indices.png}
  ...
  \caption*{\footnotesize Nota: el PIB por trabajador y el PIB por hora trabajada se indexan a 2010 = 100 dentro de cada actividad económica. Se excluye 2020 por no contar con GEIH anual comparable en la base del proyecto. Fuente: cálculos propios con DANE y GEIH.}
\end{figure}
