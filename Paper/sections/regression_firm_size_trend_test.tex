\begin{table}[htbp]
  ...
  \begin{tabular}{lcccc}
    ...
    \midrule
    2-3 & 0.0034 & (0.0028) & 0.243 & 5.9\% \\
    4-5 & 0.0035 & (0.0030) & 0.259 & 6.2\% \\
    6-10 & 0.0026 & (0.0034) & 0.455 & 4.5\% \\
    11-19 & 0.0028 & (0.0038) & 0.474 & 4.9\% \\
    20-30 & 0.0019 & (0.0041) & 0.646 & 3.4\% \\
    31-50 & 0.0027 & (0.0044) & 0.538 & 4.8\% \\
    51-100 & 0.0028 & (0.0042) & 0.519 & 4.9\% \\
    101+ & 0.0046 & (0.0043) & 0.295 & 8.2\% \\
    \bottomrule
  \end{tabular}
  \vspace{0.3em}
