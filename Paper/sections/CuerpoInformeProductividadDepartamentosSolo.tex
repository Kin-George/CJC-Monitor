...
\textbf{El informe está organizado en cinco secciones, incluyendo esta introducción.} La sección 2 presenta la metodología y las fuentes. La sección 3 compara la productividad laboral de los departamentos. La sección 4 distingue entre niveles y crecimientos de la productividad, presenta una clasificación por cuadrantes, discute la relación entre crecimiento de ocupados y productividad, y desarrolla un ejercicio descriptivo de convergencia. La sección 5 presenta conclusiones. El apéndice incluye el detalle de cada departamento.
...
\textbf{El análisis se restringe a 24 departamentos comparables durante todo el periodo 2010–2025.} Esta decisión sigue la cobertura utilizada por el DANE en los anexos de las cuentas departamentales del PIB y responde a criterios de consistencia estadística. Aunque los microdatos de la GEIH contienen observaciones para otros departamentos, en varios casos estas no alcanzan un tamaño muestral suficiente para producir estimaciones representativas y confiables de los indicadores analizados. Además, la incorporación de algunos departamentos de la Amazonía y la Orinoquía en la cobertura de la GEIH ocurrió en años más recientes, por lo que incluirlos implicaría trabajar con una cobertura territorial cambiante a lo largo del periodo. Para evitar imputaciones, rupturas artificiales en las series y comparaciones que no sean homogéneas en el tiempo, se excluyen San Andrés y Providencia y los departamentos que no hacen parte del panel tradicional de la encuesta desde 2010. Bogotá D.C. se trata como departamento, en línea con su clasificación en las cuentas nacionales departamentales.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{Paper/figures/fig_pib_geih_productividad_departamento_mapa_productividad_niveles.png}
  \caption{Mapa de niveles de productividad laboral departamental, 2024pr}
  \label{fig:pib_geih_productividad_departamento_mapa_productividad_niveles}
  \caption*{\footnotesize Nota: los paneles de la izquierda muestran mapas de calor por departamento; los paneles de la derecha representan cada departamento con una burbuja proporcional al número de ocupados en 2024pr. Los departamentos no comparables aparecen en gris. Fuente: cálculos propios con DANE y GEIH; geometría departamental de GADM.}
\end{figure}

\textbf{El mapa de niveles refuerza la concentración territorial de la productividad.} Bogotá D.C., Meta, Santander y Valle del Cauca aparecen entre los departamentos con mayores niveles de productividad, mientras que varios departamentos del norte y del sur del país se ubican en niveles más bajos. Al mirar las burbujas, también se observa que algunos de los mercados laborales más grandes no necesariamente coinciden con los mayores niveles de productividad.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{Paper/figures/fig_pib_geih_productividad_departamento_mapa_productividad_crecimientos.png}
  \caption{Mapa de crecimiento de la productividad laboral departamental, 2010--2024pr}
  \label{fig:pib_geih_productividad_departamento_mapa_productividad_crecimientos}
  \caption*{\footnotesize Nota: los paneles de la izquierda muestran mapas de calor por departamento; los paneles de la derecha representan cada departamento con una burbuja proporcional al número de ocupados en 2024pr. En los mapas de crecimiento, la escala de color se centra en el crecimiento agregado de los 24 departamentos comparables. Los departamentos no comparables aparecen en gris. Fuente: cálculos propios con DANE y GEIH; geometría departamental de GADM.}
\end{figure}

\textbf{El mapa de crecimientos muestra que las diferencias no son marginales.} La distancia entre los departamentos de mayor y menor crecimiento supera cinco puntos porcentuales anuales cuando se mide la productividad por hora. El desempeño agregado del país, por tanto, oculta trayectorias territoriales muy distintas.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{Paper/figures/fig_pib_geih_productividad_departamento_mapa_cuadrantes.png}
  \caption{Mapa de cuadrantes de productividad por hora, 2010--2024pr}
  \label{fig:pib_geih_productividad_departamento_mapa_cuadrantes}
  \caption*{\footnotesize Nota: las categorías son las mismas de la Figura \ref{fig:pib_geih_productividad_departamento_cuadrantes}. El panel izquierdo muestra la clasificación por departamento y el panel derecho representa cada departamento con una burbuja proporcional al número de ocupados en 2024pr. Los departamentos no comparables aparecen en gris. Fuente: cálculos propios con DANE y GEIH; geometría departamental de GADM.}
\end{figure}

\textbf{La lectura geográfica muestra que el dinamismo de la productividad y el tamaño del mercado laboral no siempre coinciden.} Algunos departamentos aceleradores tienen un peso laboral relativamente pequeño, mientras que departamentos con más ocupados, como Antioquia, Cundinamarca y Atlántico, aparecen con crecimientos de productividad por hora por debajo del agregado.
...
\textbf{El crecimiento de los ocupados no siempre coincidió con el crecimiento de la productividad.} Departamentos como Cundinamarca, Atlántico y Meta aumentaron sus ocupados a ritmos relativamente altos, pero registraron un crecimiento débil o negativo del PIB por hora. En contraste, Quindío, Caquetá y Chocó tuvieron alto crecimiento de productividad con caídas o bajo crecimiento de ocupados. Esta evidencia no prueba por sí sola una mala asignación territorial del trabajo, pero sí plantea una pregunta importante para la política pública: qué condiciones permiten que el empleo y la productividad crezcan al mismo tiempo.
