...
Figure~\ref{fig:adjusted-formality-endpoints} provides the regression-adjusted counterpart to Figure~\ref{fig:income-formality-comparison}. Econometrically, the figure estimates the firm-size-by-formality specification separately for 2008 and 2025, controlling for gender, age, age squared, education, and sector fixed effects. It then plots the implied percentage premium for each firm-size category relative to solo workers within the same formality-year group: \(\beta_g\) for informal workers and \(\beta_g+\theta_g\) for formal workers. The purpose is to ask whether the raw formality-specific profiles in Figure~\ref{fig:income-formality-comparison} survive once workers are compared within the same year, sector, formality status, and observable characteristics. Among formal workers, the raw U-shape largely disappears after controls: in 2025, the adjusted estimates for all categories below 101+ range from -3.7 to 0.6 percent, and the 101+ estimate is 10.5 percent with a confidence interval that includes zero. The 2008 formal profile is similar. Among informal workers, by contrast, the adjusted size profile remains steep and statistically significant: in 2025, the premium rises from 24.3 percent in firms with 2--3 workers to 53.6 percent in firms with 101 or more workers. Thus, the descriptive U-shape among formal workers appears to be driven mainly by worker composition within formal solo work, while the informal firm-size premium survives the controls.
