...
This result places Colombia between two strands of the literature on firm pay premia and wage inequality. In high-income settings, several studies argue that rising between-firm pay differences are central to the increase in wage inequality: \citet{CardHeiningKline2013} show that establishment-level pay premiums and worker sorting contributed to the rise of wage inequality in West Germany, while \citet{Song2019} document the growing role of between-firm inequality in the United States. Evidence from Brazil shows that firm-related wage components can also compress over time when institutions and labor-market conditions raise wages at the lower end of the distribution \citep{AlvarezBenguriaEngbomMoser2018,EngbomMoser2022}. Relative to these benchmarks, the Colombian evidence does not show either a statistically clear steepening or a clear narrowing of the firm-size wage premium. The best interpretation is persistence with suggestive but inconclusive widening: firm scale remains strongly associated with hourly wages throughout the period, but the data do not support a strong claim that this association has systematically intensified.
