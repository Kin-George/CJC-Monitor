...
but remains above their observable-controls benchmark of 0.036. The split by
formality is more revealing: the estimated elasticity is 0.026 among formal
workers and 0.130 among informal workers. The elasticity benchmark therefore
reinforces the formality results above. The Colombian firm-size wage premium is
not only a generic size-wage regularity; its steepest part is tied to informal
employment and to the structure of small-scale production.
