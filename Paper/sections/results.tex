...
The dynamic exercise also clarifies what it would mean for the firm-size wage gap to steepen or flatten over time. A steepening premium would mean that firm size has become more strongly associated with wages. A flattening premium would mean that the association has weakened, but it would not identify whether the change came from faster wage growth in smaller firms or slower wage growth in larger firms. The estimates therefore describe the time path of the wage gap; Section~6 discusses how this evidence should be interpreted.
...
Table~\ref{tab:formality-interaction-coefficients} reports the coefficients behind Equation~(\ref{eq:formality-interaction}). The estimates of \(\beta_g\), which measure the firm-size premium among informal workers, are positive and statistically significant in every firm-size category. The estimates of \(\theta_g\) are negative in every category, showing that the formal-worker profile is flatter than the informal-worker profile. In several categories the negative interaction nearly offsets the informal premium, so the implied formal-worker premium \(\beta_g+\theta_g\) is small and not statistically different from zero at the 5 percent level when formal solo workers are the reference category. This is why the adjusted figures show a robust size premium among informal workers but a much flatter profile among formal workers.
