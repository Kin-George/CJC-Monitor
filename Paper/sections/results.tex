...
informal firm-size premium survives the controls. %This conclusion concerns the comparison with solo workers; Table~\ref{tab:formal-101-contrasts} turns to the separate comparison between large formal firms and the middle of the formal firm-size distribution.
