...
{\Large\bfseries El crecimiento económico de Colombia dependió más del aumento del empleo que del aumento de la productividad}
\vspace{4pt}
...
\begin{list}{\textbullet}{%
  ...
  \item \textbf{La productividad por trabajador cayó en servicios públicos (-3,8\% anual), minas (-3,6\%) y construcción (-3,1\%).}
  \item \textbf{El PIB por trabajador aumentó apenas 1,1\% anual entre 2010 y 2025, por debajo del crecimiento del PIB real.}
  \item \textbf{El PIB por hora trabajada creció 1,5\% anual, pero las horas semanales promedio por trabajador cayeron 0,5\% anual.}
