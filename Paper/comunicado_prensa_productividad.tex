...
\textbf{Entre 2010 y 2025, el PIB por hora trabajada creció al 1,51\% anual, por encima del PIB por trabajador (1,05\%).} Esta diferenica se explica por la caída en las horas semanales promedio por trabajador, las cuales disminuyeron 0,45\% anual. Mientras tanto,  el número de personas ocupadas aumentó a un ritmo del 2\% anual, lo que explica el crecimiento del PIB real del 3,16\% anual. La descomposición del crecimiento del PIB entre el crecimiento de los ocupados, el crecimiento de las horas trabjadas y el crecimiento del PIB por hora trabjada se presenta en la Figura \ref{fig:comunicado_descomposicion}. 
