...
\textbf{Estudiar la productividad es importante porque el ingreso por habitante depende de cuántas personas trabajan y de cuánto produce cada trabajador.} El PIB por habitante puede descomponerse entre la proporción de ocupados dentro de la población y el PIB por ocupado. En un país que envejece, la proporción de ocupados por habitante tiende a crecer menos o a disminuir, de modo que Colombia no puede depender indefinidamente de incorporar más trabajadores para elevar el ingreso promedio. Si ese componente pierde fuerza, la principal vía para sostener mejoras en ingresos, competitividad y bienestar es aumentar el producto por trabajador y el producto por hora trabajada.
