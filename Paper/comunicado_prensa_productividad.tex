...
\textbf{Estudiar la productividad es importante porque el ingreso promedio de un país suele aproximarse con el PIB por habitante.} El PIB por habitante mide el valor que produce una economía por cada persona y puede descomponerse en dos partes: cuántas personas ocupadas hay por habitante y cuánto produce cada ocupado. En un país que envejece, la primera parte tiende a crecer menos o a disminuir; por eso, Colombia no puede depender indefinidamente de incorporar más trabajadores para elevar el ingreso promedio. Si esa relación demográfica pierde fuerza, aumentar el PIB por habitante exige aumentar el PIB por trabajador. En un contexto de menos horas promedio por trabajador, esto hace todavía más importante elevar el PIB por hora trabajada.
