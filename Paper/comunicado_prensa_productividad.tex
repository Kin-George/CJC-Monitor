...
{\Large\bfseries Colombia creció más sumando empleos que haciendo más productivos a sus trabajadores}
\vspace{4pt}

\textbf{Un informe del Centro Javeriano de Competitividad encuentra caídas de productividad en los servicios públicos, la minería y la construcción.}
...
\textbf{El informe también distingue entre actividades con alto nivel de productividad y actividades donde la productividad crece más rápido.} Información y comunicaciones aparece como una rama líder en auge: tiene un nivel de productividad por hora superior al agregado y además crece por encima del promedio. Arte, recreación y otros servicios aparece como una rama aceleradora: crece con fuerza, aunque todavía parte de un nivel de productividad inferior al agregado. En contraste, minas y servicios públicos conservan niveles altos de productividad por hora, pero registran caídas durante el periodo. Construcción combina un nivel bajo con una caída de la productividad. El Cuadro \ref{tab:comunicado_productividad_sector} presenta la evolución de la productividad por hora y por trabajador de cada actividad.
...
\textbf{Descargue y consulte el informe \href{https://github.com/Kin-George/CJC-Monitor/raw/main/Outputs/Informe_01_20260614.pdf}{aquí}.}. Contáctenos en \href{mailto:cjce@javeriana.edu.co}{cjce@javeriana.edu.co}.
