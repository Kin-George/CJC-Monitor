...
\textbf{Entre 2010 y 2025, el PIB por hora trabajada creció 1,51\% anual, por encima del PIB por trabajador (1,05\%).} Esta diferencia se explica por la caída en las horas semanales promedio por trabajador, que disminuyeron 0,45\% anual. Al mismo tiempo, el número de personas ocupadas aumentó 2,09\% anual, por lo cual cerca de dos de los poco más de tres puntos porcentuales de crecimiento anual del PIB se explican por el aumento de la población ocupada y el resto por el aumento del producto por trabajador. A su vez, el crecimiento de 1,05\% anual del producto por trabajador se explica por el aumento de 1,51\% anual del producto por hora trabajada y por una caída de 0,45\% anual en las horas trabajadas por ocupado. La Figura \ref{fig:comunicado_descomposicion} descompone el crecimiento del PIB entre el aumento de los ocupados, la variación de las horas trabajadas por ocupado y el crecimiento del PIB por hora trabajada.
