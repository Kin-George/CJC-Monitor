...
\begin{list}{\textbullet}{%
  ...
  \item \textbf{De 2010 a 2025 la productividad laboral cayó en actividades económicas como los servicios públicos, la minería y la construcción.}
  \item \textbf{Durante el mismo periodo, el PIB por hora trabajada para el total de la economía creció 1,5\% anual, pero las horas semanales promedio por trabajador cayeron 0,5\% anual.}
  \item \textbf{En consecuencia, el PIB por trabajador creció un 1,1\% anual, dos puntos porcentuales por debajo del crecimiento del PIB total.}
  %\item \textbf{En consecuencia, buena parte del crecimiento económico dependió más de tener más personas ocupadas que de producir más por trabajador.}
  
  \item \textbf{El PIB por trabajador aumentó apenas 1,1\% anual entre 2010 y 2025, por debajo del crecimiento del PIB real.}
\end{list}
\end{minipage}
...
\textbf{Descargue y consulte el informe \href{https://github.com/Kin-George/CJC-Monitor/raw/main/Outputs/Informe_01_20260619.pdf}{aquí}.}. Contáctenos en \href{mailto:cjce@javeriana.edu.co}{cjce@javeriana.edu.co}.
