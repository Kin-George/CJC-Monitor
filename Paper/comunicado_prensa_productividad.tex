...
\begin{itemize}
  \item La productividad por trabajador cayó en servicios públicos (-3,8\% anual), minas (-3,6\%) y construcción (-3,1\%).
  \item El PIB por trabajador aumentó apenas 1,1\% anual entre 2010 y 2025, por debajo del crecimiento del PIB real.
  \item El PIB por hora trabajada creció 1,5\% anual, pero las horas semanales promedio por trabajador cayeron 0,5\% anual.
  \item En consecuencia, buena parte del crecimiento económico dependió más de tener más personas ocupadas que de producir más por trabajador.
\end{itemize}
\end{minipage}
