...
\textbf{La productividad importa porque el ingreso promedio de cada habitante de un país es proporcional a lo que produce cada trabajador.} El PIB por habitante puede descomponerse en dos partes: qué proporción de la población está ocupada y cuánto produce cada trabajador. En un país que envejece, la proporción de ocupados por habitante disminuye. Por lo tanto, Colombia no puede depender indefinidamente de aumentar esa proporción para elevar el ingreso promedio. El aumento del ingreso por habitante dependerá cada vez más de aumentar el PIB por trabajador.
