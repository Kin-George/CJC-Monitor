...
\textbf{La productividad importa porque el ingreso promedio de un país depende del valor que produce por habitante.} A escala de toda la economía, producción e ingreso están conectados: el valor que se produce es la base de los salarios, las utilidades y otros ingresos. Por eso, el PIB por habitante se usa como una aproximación al ingreso promedio y puede descomponerse en dos partes: qué proporción de la población está ocupada y cuánto produce cada trabajador. En un país que envejece, la proporción de ocupados dentro de la población tiende a crecer menos o a disminuir. Por lo tanto, Colombia no puede depender indefinidamente de aumentar esa proporción para elevar el ingreso promedio. Si esa fuente demográfica pierde fuerza, el aumento del ingreso por habitante dependerá cada vez más de aumentar el PIB por trabajador y, en un contexto de menos horas promedio por trabajador, de elevar el PIB por hora trabajada.
