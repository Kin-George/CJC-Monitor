...
\begin{frame}{Trayectorias anuales de la productividad}
  \idea{La trayectoria anual muestra momentos distintos: algunos aumentos se concentraron antes de 2016, otros después de la pandemia.}

  \vspace{0.1cm}
  \begin{center}
    \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{fig_pib_geih_productividad_sector_indices.png}
  \end{center}

  \fuente{Fuente: cálculos propios con DANE y GEIH.}
\end{frame}

\begin{frame}{Descomposición por actividad económica}
  \idea{Las diferencias entre actividades reflejan combinaciones distintas de ocupación, horas trabajadas y productividad por hora.}

  \vspace{0.1cm}
  \begin{center}
    \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{fig_pib_geih_descomposicion_sector.png}
  \end{center}
