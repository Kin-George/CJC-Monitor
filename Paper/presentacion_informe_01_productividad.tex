...
\begin{frame}{Nivel y crecimiento de la productividad por hora}
  \idea{La comparación por ramas distingue entre líderes en auge, aceleradoras, líderes en declive y rezagadas.}
  ...
  \vspace{0.05cm}
  \begin{center}
    \includegraphics[width=0.98\textwidth,height=0.70\textheight,keepaspectratio]{fig_pib_geih_productividad_burbujas_2025.png}
  \end{center}
\end{frame}
