...
\begin{frame}{Motivación de la serie}
  \idea{El Centro Javeriano de Competitividad lanza hoy la Serie de Informes sobre la Productividad en Colombia}

  \vspace{0.4cm}
  \begin{itemize}
    %\item La productividad es resultado de políticas públicas, decisiones de inversión, adopción tecnológica y organización empresarial.
    \item En el largo plazo, el crecimiento, el bienestar, la pobreza y la distribución del ingreso dependen esencialmente de la productividad.
    \item La serie buscar estudiar y diagnosticar la productividad en Colombia con el fin de identificar las acciones de política publica y las iniciativas del sector privado con más potencial de generar un aumento sostenido de la productividad.
    %\item La serie comenzará medir cómo evoluciona la productividad entre actividades económicas, entre territorios y entre grupos de trabajadores, para después evaluar los éxitos y los fracasos así como las oportunidades y amenazas. 
...
\begin{frame}{Por qué importa la productividad laboral}
  ...
  \vspace{0.4cm}
  \begin{itemize}
    \item El crecimiento del ingreso por habitante depende de la participación laboral y de cuánto produce cada trabajador.
    \item En una sociedad que envejece, el margen para crecer solo con aumentos de la participación laboral será cada vez menor.
    \item La productividad laboral debe ser una prioridad de la agenda económica.
  \end{itemize}
\end{frame}

\begin{frame}{Qué mide el informe}
  \idea{El informe mide el producto por trabajador y el producto por hora trabajada.}
  ...
  \vspace{0.25cm}
  \begin{itemize}
    \item El PIB proviene de las cuentas nacionales del DANE.
    \item Los ocupados y las horas trabajadas se calculan con la GEIH.
...
%  {\small La línea vertical marca el nivel agregado en 2025; la horizontal, el crecimiento agregado entre 2010 y 2025.}
  ...
  \vspace{0.05cm}
  \begin{center}
    \includegraphics[width=1.3\textwidth,height=0.99\textheight,keepaspectratio]{fig_pib_geih_productividad_burbujas_2025.png}
  \end{center}
\end{frame}
